            ...
            <div
                ...
                <form class="my-4" wire:submit="saveNewKey">
                    <div class="grid md:grid-cols-1 gap-6">
                        ...
                        <div>
                            <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">string value</label>
                            <textarea id="message" rows="4"  wire:model="value" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="string value will appear in the app "></textarea>
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td style="width: 60%; vertical-align: middle;" class="p-0">
                                                <input type="text"
                                                       ...
                                                       wire:model="inputTranslations.{{$t->id}}" value="{{ $t->value }}"/>
                                            </td>
                                        </tr>
                                    @endforeach
                                </table>
